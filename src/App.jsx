...
function App() {
  return (
    <div className="App">
      ...
      <Card frontSideTitle="Cornwall" backSideTitle="Eden Project" frontSideImage={"https://www.heraldry-wiki.com/heraldrywiki/images/9/95/Cornwall.jpg"} backSideImage={"https://upload.wikimedia.org/wikipedia/commons/7/75/Eden_project.JPG"} backSideText="Dubbed the Eighth Wonder of the World by some, Eden is a dramatic global garden housed in tropical biomes that nestle in a crater the size of 30 football pitches. The complex is dominated by two huge enclosures consisting of adjoining domes that house thousands of plant species and each enclosure emulates a natural biome."/>
